...
- icon: linkedin
  icon_pack: fab
  link: https://www.linkedin.com/in/doedmond/
- icon: github
  icon_pack: fab
...
Edmond Sanou is a doctoral student supervised by [Pr. Christophe Ambroise](http://www.math-evry.cnrs.fr/members/cambroise/welcome), in the [Laboratory of Mathematics and Modeling](https://math-evry.cnrs.fr/) at the [University of Evry](https://www.univ-evry.fr/). He holds a master's degree in biostatistics from the [National School of Statistics](http://http://ensai.fr/) and is pursuing a doctorate in mathematics applied to genomics. Edmond also gives tutorials to undergraduate students.
